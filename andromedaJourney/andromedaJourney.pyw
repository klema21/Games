...
games.init(screen_width = 768, screen_height = 816, fps = 50)
...
class Asteroid(Wrapper):
    ...
    MEDIUM = 2
    LARGE = 3
    images = {SMALL  : games.load_image("36x36.png"),
              MEDIUM : games.load_image("51x51.png"),
              LARGE  : games.load_image("106x106.png") }
...
class Ship(Collider):
    ...
    image = games.load_image("shuttle2.png")
